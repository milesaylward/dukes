...
export const Facebook = (props) => {
  const styles = props.Styles ? props.Styles : iconStyle
  return (
    <a href='https://www.facebook.com/DukesDeliciousMeats/' target='_blank' rel="noopener noreferrer">
      <svg style={styles} viewBox="0 0 24 24" className='contact-icons'>
